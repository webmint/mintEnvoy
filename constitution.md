...
| Test file        | **tests**/ co-located    | Icon.test.tsx, Icon.ct.tsx |
...
- [extracted] co-located tests under **tests**/ next to the code, split .test.tsx (Vitest) and .ct.tsx (Playwright CT)
