...
└── renderer/
    ...
    │   │   ├── atoms/          # Icon
    │   │   ├── molecules/      # Divider, Dropdown, Modal, Tabs, Toast
