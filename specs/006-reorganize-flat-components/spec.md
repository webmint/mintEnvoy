...
- Must follow: Move each relocated component's sibling .css and co-located __tests__/ fixtures together with its .tsx, and update all @renderer import paths in both production callers and test/story fixtures.
