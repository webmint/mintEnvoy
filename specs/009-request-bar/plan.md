...
| tests (new / extend)                    | RequestBar unit + CT; tabsStore `updateActiveSpec` cases                                                                                                                                                        | src/renderer/src/components/organisms/**tests**/RequestBar.test.tsx, src/renderer/src/components/organisms/**tests**/RequestBar.ct.tsx, src/renderer/src/lib/**tests**/tabsStore.test.ts |
...
| src/renderer/src/components/organisms/**tests**/RequestBar.test.tsx | Create | unit: trim guard, method-switch independence, Save dirty/no-op, per-tab render isolation                                                                                       |
| src/renderer/src/components/organisms/**tests**/RequestBar.ct.tsx   | Create | CT: layout, disabled Send, ⌘↵/⌘S, method-dropdown dismiss (two-step gate), per-tab isolation; fixtures import tokens.css + set data-mstyle                                     |
| src/renderer/src/lib/**tests**/tabsStore.test.ts                    | Modify | add `updateActiveSpec` cases: dirty-on-change, no-op-no-flip, per-tab isolation                                                                                                |
