...
| ---------- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------- |
| architect  | Atomicity / ordering / contract-chain for the 1-task decomposition + agent assignment | One task correct (do not split per case); deps clean; contracts trace; fixed two Expects defects (AC-3/AC-4 labels swapped, non-verbatim focus-return test name); frontend-engineer accepted | accepted | specs/008-dropdown-ct-dismiss/plan.md; src/renderer/src/components/molecules/**tests**/Dropdown.ct.tsx:185,236 |
| (none)     | —                                                                                     | —                                                                                                                                                                                            | —        | —                                                                                                              |
