...
You are a skeptical second opinion. Another agent reviewed the assembled feature and
...
new review. Do NOT look for new bugs. Do NOT add findings. You judge ONLY the
