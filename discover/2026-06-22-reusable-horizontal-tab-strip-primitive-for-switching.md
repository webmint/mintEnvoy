...
| §3.4 Testing Requirements                        | success_criteria's behavior/keyboard/ARIA gate is met with interaction tests mirroring the existing Dropdown/Toast **tests** patterns.                   |
