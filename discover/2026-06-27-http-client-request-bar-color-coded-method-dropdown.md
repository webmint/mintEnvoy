...
| §3.4 Co-located tests + §3.3 PascalCase one-per-file                     | RequestBar.tsx + sibling RequestBar.css; tests under **tests**/ split .test.tsx (Vitest) and .ct.tsx (Playwright CT).                                                                                                                                                                                                      |
